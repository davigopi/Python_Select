...
path_newcon_json_tratado = p_df + arq_json_newcon + tratado + ext_JSON
...
path_newcon = {
    ...
    'id_ctl00_Conteudo_grdContemplacoes_Confirmadas_Canceladas':
        '//*[@id="ctl00_Conteudo_grdContemplacoes_Confirmadas_Canceladas"]',
...
table_click_newcon = {
    ...
    canc: 'id_ui_id_8',
    desc: 'id_ui_id_9',
    apur: 'id_ctl00_Conteudo_btnCotasSorteadas',
}


table_get_newcon = {
    conf: 'id_ctl00_Conteudo_grdContemplacoes_Confirmadas',
    canc: 'id_ctl00_Conteudo_grdContemplacoes_Confirmadas_Canceladas',
    desc: 'id_ctl00_Conteudo_div_Desclassificadas',
    apur: 'id_ctl00_Conteudo_grdContemplacoes_Confirmadas_Canceladas',
}
